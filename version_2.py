...
from theme_generation_v2 import theme_generation_pipeline
...
def main():
    ...
    experiments_folder = "experiments_v2"
    lowercase = True
    granularities = [
        Granularity.SECTION,
    ...
    for granularity in granularities:
        for reasoning in reasonings:
            ...
            create_experiment_folder(experiments_folder = experiments_folder, testname=testname, lowercase=lowercase, granularity=granularity, prompt=prompt)
            ...
            random_explanation_baseline(experiment_folder, testname) #Semantic Baseline
            nli_random_baseline(experiment_folder, testname) #NLI Baseline
            random_nli_calc(experiment_folder, testname) 
            random_semantic_calc(experiment_folder, testname)

    print("Stage One - Coding completed.")

    reasoning = Reasoning.INDUCTIVE
    ...
    if reasoning == Reasoning.INDUCTIVE:
        ...
        for previous_granularity, new_granularity in theme_transitions:
            ...
            theme_generation_pipeline(stage, previous_granularity, new_granularity, testname)
            ...
            thematic_projections_method(
                ...
                experiment_folder / "theme_grouping_input.json"
            )