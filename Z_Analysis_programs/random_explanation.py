...
def random_explanation_baseline(experiment_folder, test_name, display = True):
    """
    ...
    JSON_FOLDER = f"{experiment_folder}/{test_name}/output_files"

    folder_path = f"{experiment_folder}/{test_name}/statistics"

    os.makedirs(folder_path, exist_ok=True)

    output_folder = f"{experiment_folder}/{test_name}/statistics"
